        ...
        if file in true_doc_rl:
            ...
            for prl in pred_rl:
                ...
                for trl in true_rl:
                    ...
                    # if prl.arg2.span == trl.arg2.span:
                    #     if prl.arg1.span == trl.arg1.span:
                    #         if prl.type == trl.type:
                    #             correct_count += 1
                    #         else:
                    #             print_prl_trl(prl, trl)
                    #             wrong_type_count += 1
                    #     elif prl.arg1.name == trl.arg1.name:
                    #         if prl.type == trl.type:
                    #             print_prl_trl(prl, trl)
                    #             wrong_span_count += 1
                    #     elif is_similar(prl.arg1.name, trl.arg1.name):
                    #         if prl.type == trl.type:
                    #             print_prl_trl(prl, trl)
                    #             similar_count += 1
                    #     else:
                    ...
                    if is_overlap(prl.arg2.span, trl.arg2.span):
                        if is_overlap(prl.arg1.span, trl.arg1.span):
                            ...
                            if prl.type == trl.type:
                                correct_count += 1
                                if overlap_len(prl.arg2.span, trl.arg2.span) != prl.arg2.span[1] - prl.arg2.span[0] or \
                                    overlap_len(prl.arg2.span, trl.arg2.span) != trl.arg2.span[1] - trl.arg2.span[0] or \
                                    overlap_len(prl.arg1.span, trl.arg1.span) != prl.arg1.span[1] - prl.arg1.span[0] or \
                                    overlap_len(prl.arg1.span, trl.arg1.span) != trl.arg1.span[1] - trl.arg1.span[0]:
                                    # print(overlap_len(prl.arg2.span, trl.arg2.span))
                                    # print(overlap_len(prl.arg1.span, trl.arg1.span))
                                    print_prl_trl(prl, trl)
                                    # print(prl)
                                    # print(trl)
                                # if overlap_len(prl.arg1.span, trl.arg1.span) != prl.arg1.span[1] - prl.arg1.span[0] or overlap_len(prl.arg1.span, trl.arg1.span) != trl.arg1.span[1] - trl.arg1.span[0]:
                                #     print(overlap_len(prl.arg2.span, trl.arg2.span))
